...
RSpec.describe 'Admin Dashboard' do
  describe 'As an Admin' do
    before :each do
      ...
      @m_user_address = @m_user.addresses.create(address: '123 Main St', city: 'Denver', state: 'CO', zip: 80218)
      ...
      @order_1 = @m_user.orders.create!(status: "packaged", address_id: @m_user_address.id)
      @order_2 = @m_user.orders.create!(status: "pending", address_id: @m_user_address.id)
      @order_3 = @m_user.orders.create!(status: "cancelled", address_id: @m_user_address.id)
