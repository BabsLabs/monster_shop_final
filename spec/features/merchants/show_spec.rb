...
RSpec.describe 'Merchant Show Page' do
  describe 'As a visitor' do
    before :each do
      ...
      @user_1_address = @user_1.addresses.create!(address: '123 Main St', city: 'Denver', state: 'CO', zip: 80218)
      ...
      @user_2_address = @user_2.addresses.create!(address: '123 Main St', city: 'Denver', state: 'CO', zip: 80218)
