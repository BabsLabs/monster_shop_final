...
RSpec.describe Merchant do
  ...
  describe 'Instance Methods' do
    before :each do
      ...
      @address_2 = @user_2.addresses.create!(address: '123 Main St', city: 'Denver', state: 'CO', zip: 80218)
      @order_1 = @user_1.orders.create!(address_id: @address_1.id)
      @order_2 = @user_2.orders.create!(status: 1, address_id: @address_1.id)
      @order_3 = @user_2.orders.create!(status: 1, address_id: @address_1.id)
